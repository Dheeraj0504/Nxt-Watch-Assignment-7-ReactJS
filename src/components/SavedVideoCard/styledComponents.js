...
`
export const SavedVideoContentSection = styled.div`
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
  padding-top: 5px;
...
`
export const SavedVideoChannelAndViews = styled.div`
  display: flex;
  align-items: center;
  @media screen and (min-width: 768px) {
    flex-direction: column;
...
`
export const SavedVideoViewsAndDate = styled.p`
  font-family: Roboto;
  font-size: 12px;
  margin-top: 3px;
  margin-left: 10px;
...
`
export const SavedVideoDot = styled.span`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  padding-left: 10px;
